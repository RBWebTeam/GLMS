...
<div class="fh5co-contact animate-box">
                      ...
                      <div class="col-md-2"></div>
                            ...
                            <form >
                                 <h1 class="loan-head">Course Related Details</h1>
...
<script type="text/javascript">
   ...
   var msg=$.parseJSON(datas);
    ...
    var tablerows = new Array();
       ...
       if(msg){
                            $('#coursedetails').empty().append('<table class="table table-striped table-bordered"><tr class="text-capitalize"><td style="font-family: monospace">Course Type</td><td style="font-family: monospace">Course Package</td></tr><tr>'+tablerows+'</tr></table>');
                         }else{
                            $('#coursedetails').empty().append('No Result Found');
                         }
